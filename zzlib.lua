...
if not lua_version or lua_version < 5.3 then
  ...
  infl = loadstring(game:HttpGet("https://raw.githubusercontent.com/Babyhamsta/zzlib/master/inflate-bit32.lua", true))()
else
  -- From Lua 5.3, use implementation based on bitwise operators
  infl = loadstring(game:HttpGet("https://raw.githubusercontent.com/Babyhamsta/zzlib/master/inflate-bwo.lua", true))()
end
